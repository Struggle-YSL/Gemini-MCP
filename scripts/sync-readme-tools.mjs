...
try {
  ...
  console.error("[sync-readme-tools] Failed to load dist/tool-manifest.js. Run npm run build first.");
...
console.log("[sync-readme-tools] README tool block updated from tool manifest.");
