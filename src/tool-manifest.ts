...
export const TOOL_MANIFEST = [
  {
    ...
    description: "使用 Gemini AI 生成前端组件（React/Vue/HTML），支持注入项目设计上下文",
  ...
  },
  {
    ...
    category: "frontend-base",
    description: "使用 Gemini AI 审查 UI 代码，给出可访问性、设计一致性和用户体验方面的改进建议",
    supportsSessionId: true,
    requiresProjectContext: false,
    taskSupport: "optional",
  },
  ...
  },
  {
    ...
    category: "runtime",
    description: "推进主 agent 的 WorkItem DAG 状态，生成下一步 Codex 或 Gemini 动作，但不直接落盘仓库文件",
  ...
  },
  {
    ...
    category: "runtime",
    description: "执行一次 orchestrator loop tick：推进 DAG、自动提交 ready 的 Gemini work item，并返回更新后的编排状态",
    supportsSessionId: false,
    requiresProjectContext: true,
    taskSupport: "optional",
  },
  ...
  },
  {
    ...
    category: "runtime",
    description: "读取 orchestrator 的结构化最终汇总、失败补偿状态和 work item 事件轨迹",
    supportsSessionId: false,
    requiresProjectContext: false,
    taskSupport: "optional",
  },
  {
    ...
    category: "runtime",
    description: "读取当前进程的 Gemini runtime、process-control、task execution、orchestrator runtime 和持久化诊断信息",
    supportsSessionId: false,
    requiresProjectContext: false,
    taskSupport: "optional",
  },
  {
    ...
    category: "runtime",
    description: "读取主 agent 可消费的 orchestrator 决策包，包括 recommended actions、manual actions、已完成结果摘要和自然语言 summary",
    supportsSessionId: false,
    requiresProjectContext: false,
    taskSupport: "optional",
  },
  {
    ...
    category: "runtime",
    description: "应用 Codex 对 orchestrator run 的决策，支持 provide-result、retry-work-item 和 mark-failed",
    supportsSessionId: false,
    requiresProjectContext: false,
    taskSupport: "optional",
  },
...
export function assertToolManifestIntegrity(): void {
  ...
  if (uniqueNames.size !== names.length) {
    ...
    throw new Error(`Duplicate tool names found in tool manifest: ${duplicates.join(", ")}`);
  }
}
